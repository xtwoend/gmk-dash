...
<div class="row row-deck row-cards">
    <div class="col-12">
        <div class="card">
            ...
            <form method="GET" action="{{ route('device-products.index') }}">
                ...
                <div class="d-flex">
                    ...
                    <div class="ms-auto text-muted">
                        ...
                        <div class="ms-2 d-inline-block">
                            <input type="text" name="keyword" class="form-control form-control-sm" placeholder="Search product messages..." value="{{ request('keyword') }}" onkeyup="if(event.keyCode==13) this.form.submit()">
                        </div>
                    </div>
                </div>
            </div>
